 ...
 * @return {string}       List of secrets visible to this user, separated by "|"
 */
...
/**
 * This function renders secret messages generated by the program
...
function App() {
    ...
    const getName = () => {
        if (!isAuthenticated) {
            ...
            getAccessTokenSilently().then(async (usertoken) => {
        ...
        <div className="App">
            <header className="App-header">
                <div>
                    ...
                    <p>Please click the buttons from left to right</p>
                </div>
                ...
                <div>
                    ...
                    &nbsp;
                    <Button onClick={() => getName(user)}>Show Messages</Button>
                    &nbsp;
                    <Button
                        onClick={() =>
                            isAuthenticated ? logout() : alert('Log In first!')
                        }
                    >
                        Log Out
                    </Button>
