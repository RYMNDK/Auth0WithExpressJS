...
//assume this is a secured redis database
const resources = {
...
function getResourceFromAuthenticationHeader(token) {
    const separator = "|"; //separator agreed on with frontend
    var longstring = "";
    ...
    longstring = decodedJWT
        ...
        .reduce((acc, cur) => acc + separator + cur); //flatten the list and add in separator
